...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        ...
        LinearLayout linearLayout = new LinearLayout(MyApplication.getmContext());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(MyApplication.getmContext());
        ...
        tv.setTextColor(MyApplication.getmContext().getResources().getColor(isSelf() ? R.color.white : R.color.black));
    ...
    public String getSummary() {
        ...
        return MyApplication.getmContext().getString(R.string.summary_voice);
    }
