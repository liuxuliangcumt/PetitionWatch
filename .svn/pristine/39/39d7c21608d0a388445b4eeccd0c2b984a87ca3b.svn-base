package com.realpower.timchat.presenter;

import android.util.Log;

import com.realpower.timchat.event.FriendshipEvent;
import com.realpower.timchat.event.GroupEvent;
import com.realpower.timchat.event.MessageEvent;
import com.realpower.timchat.event.RefreshEvent;
...
import static com.realpower.timchat.event.MessageEvent.*;
...
public class ConversationPresenter implements Observer {
    ...
    public void getConversation(){
        ...
        Log.e("aaa","getConversation  "+list.size());
        for (TIMConversation conversation : list){
            ...
            conversationExt.getMessage(1, null, new TIMValueCallBack<List<TIMMessage>>() {
                ...
                public void onSuccess(List<TIMMessage> timMessages) {
                    ...
                    Log.e("aaa", "get message onSuccess" + timMessages.size());
