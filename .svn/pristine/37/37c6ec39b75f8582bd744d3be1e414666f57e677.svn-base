    ...
    void onInitView() {
        ...
        lv_video.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                VideoPlayActivity_.intent(AlarmDetailActivity.this).path(videoData.get(position)).start();
            }
        });
        lv_voice.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new VoicePlayClickListener(voiceData.get(position), (ImageView) view.findViewById(R.id.iv_voice), AlarmDetailActivity.this).onClick(view);
            }
        });
        getData();
    }
