...
package com.realpower.petitionwatch.view.tablayout;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (bottomLineMode == 1) {
            int bottomLineColor = a.getColor(R.styleable.TabLayout_bottomLineColor, getResources().getColor(android.R.color.darker_gray));
            ...
            if (bottomLineMode==2){
               //TODO
               // mTabStrip.setBottomLineHeight(a.getDimensionPixelOffset(R.styleable.TabLayout_bottomLineHeight,0));
            }
