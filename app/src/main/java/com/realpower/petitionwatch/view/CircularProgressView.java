...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, AttributeSet attrs) {
        ...
        ringWidth = (int) array.getDimension(R.styleable.CircularProgressView_ringWidth, 10);
    ...
    public void onDraw(Canvas canvas) {
        ...
        float arcX = offsetX + outerRadius * 2 - halfRingWidth-50;
        float arcY = offsetY + outerRadius * 2 - halfRingWidth-50;
